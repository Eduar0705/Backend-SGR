/**
 * Utilidades para el cálculo y redondeo de evaluaciones
 */
 ...
 */
function aplicarRedondeoPuntaje(puntaje, porcentajeEvaluacion) {
 ...
 */
function validarEstructuraRubrica({ criterios, porcentaje, esCreacion = false }) {
...
module.exports = { aplicarRedondeoPuntaje, validarEstructuraRubrica };
